...
## How it Works
* Filters for GitHub repo pages.
* Parses out the Github Repo owner/name to lookup on Codix.
* If the repo is found then the ratings bar is displayed.
...
## Packaging
From the command-line, cd into the app dir and run `../misc/package.sh`.  This produces `codix-chrome-extension.zip` in the root directory which can be published to the chrome web store.
